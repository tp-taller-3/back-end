...
export const defaultTranslations = {
  ...
  login: {
    title: "Ingresar",
    fiubaLogin: "Ingresar con credenciales de FIUBA",
    companyLogin: "Ingresar como empresa"
  },
  applicantList: {
    title: "Postulantes"
  },
  companyJobApplicationsListTitle: {
    title: "Postulaciones"
  },
  applicantEmptyOfferList: {
    text: "No hay ofertas para los filtros seleccionados",
    button: "Ver todas"
  },
  ...
  companyEmptyNotificationList: {
    ...
    button: "Ver postulaciones"
  },
  applicantEmptyNotificationList: {
    text: "No hay notificaciones",
  ...
  careersDetail: {
    approvedSubjectCount: "materias aprobadas",
    currentCareerYear: "año",
    isGraduate: "Graduado/a",
    connector: "de"
  },
  careersSelector: {
    career: "Carrera"
  ...
  applicantCareerSelector: {
    ...
    isGraduate: "Graduado",
    approvedSubjectCount: "Materias aprobadas",
    currentCareerYear: "Año en curso",
    withoutCBC: "Sin incluir CBC",
  ...
  recipientsFormSection: {
    careers: "Carreras",
    title: "Destinatarios",
    targetApplicantType: "Estado de la carrera"
  },
  editOffer: {
    create: "Publicar oferta",
    edit: "Editar tu oferta",
    submit: "Publicar",
    confirmDialogTitle: "¿Editar oferta?",
    confirmDialogDescription:
  ...
  passwordRecovery: {
    title: "Solicitud de recuperación de contraseña",
    emailHelperText: "Se enviará un email con un link para cambiar tu contraseña",
    submit: "Enviar email",
    email: "Email"
  },
  companySignUp: {
  ...
  companyProfileTitle: {
    ...
    subtitle: "Así lo van a ver los alumnos y graduados"
  },
  ...
  companyLogin: {
    ...
    email: "Email",
    signup: "Registrar tu empresa",
    recoverPassword: "Recuperar contraseña",
    goToApplicant: "No soy empresa"
  },
  navBar: {
  ...
  typeFilterMenu: {
    title: "Tipo",
    companyIconTitle: "Empresas",
    applicantIconTitle: "Postulantes",
    offerIconTitle: "Ofertas",
    jobApplicationIconTitle: "Postulaciones"
  },
  statusFilterMenu: {
    title: "Estado",
    pending: "Pendientes",
  ...
  adminTaskList: {
    ...
    rejected: "Tareas rechazadas",
    pending_or_rejected: "Tareas pendientes o rechazadas",
  ...
  adminApplicantListMainTitle: {
    title: "Postulantes"
  },
  adminJobApplicationsListMainTitle: {
    title: "Postulaciones"
  },
  adminJobApplicationMainTitle: {
    title: "Postulación"
  },
  adminOfferMainTitle: {
  ...
  institutions: {
    extension: "Secretaría de Inclusión, Género, Bienestar y Articulación Social",
    graduados: "Subsecretaría de Relación con los Graduados"
  },
  desktopOnlyOverlay: {
    message: "Ampliar la pantalla del navegador, o reducir el zoom"
  },
  publishedSince: {
    prefix: "Publicado"
  },
